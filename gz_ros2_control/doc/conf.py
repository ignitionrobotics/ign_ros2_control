...
htmlhelp_basename = 'gz_ros_control_doc'
...
man_pages = [
    (master_doc, 'gz_ros_control', 'gz_ros_control Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'gz_ros_control', 'gz_ros_control Documentation',
     author, 'gz_ros_control', 'ROS 2 components for point cloud transport.',
     'Miscellaneous'),
]
